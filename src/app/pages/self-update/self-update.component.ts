...
export class SelfUpdateComponent implements OnInit {
  ...
  constructor(
    private selfUpdateStoreFacadeService: SelfUpdateStoreFacadeService,
  ) {}

  ngOnInit(): void {
    this.isSelfUpdateAvailable =
      this.selfUpdateStoreFacadeService.isSelfUpdateAvailable();
    this.isSelfUpdateDownloaded =
      this.selfUpdateStoreFacadeService.isSelfUpdateDownloaded();
  }
