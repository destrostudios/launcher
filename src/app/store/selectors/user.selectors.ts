...
export const isRegistrationLoading = createSelector(
  getUserState, state => state.registration && state.registration.isLoading
);
...
export const isSaltClientLoading = createSelector(
  getUserState, state => state.saltClient && state.saltClient.isLoading
);

export const isSessionIdLoading = createSelector(
  getUserState, state => state.sessionId && state.sessionId.isLoading
);
...
export const getSessionId = createSelector(
  getUserState, state => state.sessionId ? state.sessionId.data : null
);

export const isUserLoading = createSelector(
  getUserState, state => state.user && state.user.isLoading
);

export const getCurrentUser = createSelector(
  getUserState, state => state.currentUser
);

export const getLogin = createSelector(
  getCurrentUser, currentUser => currentUser ? currentUser.login : null
);

export const getOwnedAppIds = createSelector(
  getCurrentUser, currentUser => currentUser ? currentUser.ownedAppIds : null
);

const isAppAdditionToAccountLoading = createSelector(
  getUserState, state => state.appAdditionToAccount && state.appAdditionToAccount.isLoading
);

const isAppRemovalFromAccountLoading = createSelector(
  getUserState, state => state.appRemovalFromAccount && state.appRemovalFromAccount.isLoading
);

export const isAppAdditionToAccountIncludingUpdateLoading = createSelector(
  isAppAdditionToAccountLoading, isUserLoading,
  (appAdditionToAccountLoading, userLoading) => appAdditionToAccountLoading || userLoading,
);

export const isAppRemovalFromAccountIncludingUpdateLoading = createSelector(
  isAppRemovalFromAccountLoading, isUserLoading,
  (appRemovalFromAccountLoading, userLoading) => appRemovalFromAccountLoading || userLoading,
);
